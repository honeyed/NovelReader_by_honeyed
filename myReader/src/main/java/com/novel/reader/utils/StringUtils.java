...
import com.novel.reader.EasySP;
...
public class StringUtils {
    ...
    public static String getString(@StringRes int id){
        return ReaderApp.getContext().getResources().getString(id);
    }

    public static String getString(@StringRes int id, Object... formatArgs){
        return ReaderApp.getContext().getResources().getString(id,formatArgs);
    }
    ...
    public static String convertCC(String input, Context context)
    {
        ...
        int convertType = EasySP.getInstance().getInt(ReadSettingManager.SHARED_READ_CONVERT_TYPE, 0);
